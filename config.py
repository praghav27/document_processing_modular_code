...
# # Existing Azure AI Search (RFI/RFP)
# AZURE_AI_SEARCH_ENDPOINT=os.getenv("AZURE_AI_SEARCH_ENDPOINT")
# AZURE_AI_SEARCH_KEY = os.getenv("AZURE_AI_SEARCH_KEY")
# AZURE_AI_SEARCH_RFI_INDEX_NAME= os.getenv("AZURE_AI_SEARCH_RFI_INDEX_NAME")
# AZURE_AI_SEARCH_RFP_INDEX_NAME=os.getenv("AZURE_AI_SEARCH_RFP_INDEX_NAME")
...
# NEW: TIP Document Azure AI Search - USING YOUR ENDPOINT
AZURE_AI_SEARCH_TIP_ENDPOINT = os.getenv("AZURE_AI_SEARCH_TIP_ENDPOINT", "https://ttdevopscacdevsrch-rfprfi.search.windows.net")
