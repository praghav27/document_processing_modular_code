...
# )
# from config import AZURE_EMBEDDING_MODEL_NAME,AZURE_AI_SEARCH_ENDPOINT,AZURE_AI_SEARCH_KEY,AZURE_AI_SEARCH_RFP_INDEX_NAME,AZURE_EMBEDDING_MODEL,AZURE_EMBEDDING_ENDPOINT,AZURE_EMBEDDING_API_KEY,AZURE_OPENAI_API_VERSION
...
# # Create index schema
# index = SearchIndex(
#     name=AZURE_AI_SEARCH_RFP_INDEX_NAME,
#     fields=fields,
...
# index_client.delete_index(AZURE_AI_SEARCH_RFP_INDEX_NAME)

# index_client.create_index(index)
# print(f"✅ Index '{AZURE_AI_SEARCH_RFP_INDEX_NAME}' created successfully.")
