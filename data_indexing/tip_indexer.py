...
class TIPIndexer:
    ...
    def create_tip_index(self):
        ...
        fields = [
            ...
            # Document ID - Filterable, Sortable, Facetable, Searchable
            SearchableField(
                name="doc_id", 
                type=SearchFieldDataType.String, 
                filterable=True, 
        ...
        # Create scoring profile for relevance boosting - FIXED: Only include searchable fields
        scoring_profiles = [
            ScoringProfile(
                name="tipRelevanceProfile",
                text_weights=TextWeights(weights={
                    "project_name": 3.0,
                    "doc_id": 2.5,  # Now searchable, so this is valid
                    "stations_tip": 2.0,
                    "scope_of_work": 1.5,
                    "prepared_by": 1.0,
                    "qa_qc_info": 1.0
