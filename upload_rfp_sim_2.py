...
async def main():
    ...
    file_list = [
         r"C:\Users\Harshal.chaudhari\Downloads\new_scope_rfp 2\testing docs\705-22295407.00-B&M_HONI RFP-Chatham SS-Chatham_Lakeshore Instruct for Const.docx",
         r"C:\Users\Harshal.chaudhari\Downloads\new_scope_rfp 2\testing docs\705-22295407.00-B&M_HONI RFP-Chatham SS.docx"]
...
"""
    ...
    def call_openai():
        response = client.chat.completions.create(
            ...
            temperature=0.3,
            max_tokens=2000,  # Increased for multi-document response
        )
        return response.choices[0].message.content.strip()
