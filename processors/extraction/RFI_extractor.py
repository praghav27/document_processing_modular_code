...
#             client = document_metadata.get('client', '')
#             if not client:
#                 client = ''  # Keep empty if not found
                
#             region = document_metadata.get('region', '')
#             if not region:
#                 region = ''  # Keep empty if not found
                
#             industry = document_metadata.get('industry', '')
#             if not industry:
#                 industry = ''  # Keep empty if not found
                
#             prepared_date = document_metadata.get('prepared_date', '')
#             if not prepared_date:
#                 prepared_date = ''  # Keep empty if not found
...
#         # Ensure project_id is set properly for multi-file processing
#         if not project_id:
#             project_id = str(uuid.uuid4())[:8]  # Generate if not provided
...
#                 'processing_method': 'enhanced_rfi_parallel_processing',
